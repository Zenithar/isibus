...
class Graph
{
	...
	class node
	{
		...
		*/
		 ...
		 * 
		 * In the case of directed graohs, this method returns an edge going
	...
	*/
	 ...
	 * 
	 * The const node iterator allows brwosing nodes. You may not use the 
	...
	{
	    return node_iterator(nodes.lower_bound(label));
	}
	...
	{
		return const_node_iterator(nodes.lower_bound(label));
	}
